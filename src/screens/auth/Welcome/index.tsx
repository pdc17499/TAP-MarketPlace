...
const Welcome = React.memo((props: WelcomeProp) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <AppText style={styles.miniTitle}>
                {'by The Assembly Place'}
            </AppText>
            ...
            <View style={styles.signInTxt}>
                <TouchableOpacity onPress={() => moveToSignIn()}>
                    <AppText style={{ ...fontFamily.fontWeight600 }}>
                        {'Sign in'}
                    </AppText>
                </TouchableOpacity>
                <AppText
            ...
            <View>
                <AppButton title={"Explore"} size={'small'} iconRight={<CaretRight></CaretRight>} customStyleButton={{ width: scaleWidth(152) }} ></AppButton>
            </View>
        </View >
    );
});
