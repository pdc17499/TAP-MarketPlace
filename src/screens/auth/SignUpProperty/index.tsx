...
import { View, KeyboardAvoidingView, _ScrollView, ScrollView } from 'react-native';
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.body}>
        ...
        <AppText style={styles.message}>{'Hi, we want to get to know more about you'}</AppText>
        {RenderForm()}
      </View>
    </ScrollView>
  );
